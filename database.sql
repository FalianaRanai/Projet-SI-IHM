...
Coloris gris-vert.", 11), 
	(NULL, "Jean foncé XL", "25.00", "big-02",2,"Composition: 92% coton, 6% polyester, 2% élasthanne. Matière: Denim. Contient des éléments non-textiles d'origine animale: Oui. Conseils d'entretien: Ne pas mettre au sèche-linge, lavage en machine à 30°C", 12), 
	(NULL, "Doudoune bleu", "35.00", "item-03",3,"Cette doudoune courte droite sans manches Tommy Hilfiger en nylon matelassé, se pare d'une capuche surmontée de liens de serrage sur un col montant, d'une fermeture à glissière, de 2 poches en biais zippées sur l'avant et du logo cousu sur le côté gauche de la poitrine.", 88), 
	(NULL, "Sac a main bleu clair", "45.00", "item-04",2,"Sac baguette Danse Lente en cuir. Anse en chaîne pour porté épaule. Ouverture sur le dessus. Rangement intérieur. Griffe sur le devant", 64), 
	(NULL, "Sac a main rose", "55.00", "item-05",2,"Sac besace rectangulaire Danse Lente en cuir souple tressé. Anse porté main ou épaule. 2 petites lanières à nouer en fermeture. Doublure coton à bouton aimanté. Housse de rangement", 126), 
	(NULL, "Pair de Converse", "65.00", "item-06",1,"Parfaite pour un style décontracté ou habillé, cette Chuck classique en toile est indispensable à toute garde-robe. Nous avons aussi adouci la doublure et les coutures, pour un confort optimal tout au long de la journée, tous les jours.", 48),
	(NULL, "Boxer","20.00","Boxer",1,"Le boxer ou boxer short (littéralement short du boxeur) est un type de sous-vêtement qui, s'il peut être porté par les femmes, est principalement masculin. Il n’est pas à confondre avec le shorty, exclusivement porté par les femmes", 52),
	(NULL, "Capuche hiver","100.00","capuche_hiver",1,"Un choix unique de Sweat capuche homme pour hiver disponible dans notre magasin. Codes promo, ventes flash, livraison offerte, trouvez le produit de vos manches.", 72),
