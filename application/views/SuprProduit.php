			...
			<table class="table table-light  table-striped">
			  ...
			  <tbody>
				...
				<tr class="light">
				  ...
				  <td>
					<div id="bsouhait">
						<a href="<?php echo site_url()."Admin/TraitementSupprimerProduit?id=".$prod['IDProduit'];?>" style="text-decoration:none;"><button type="button" class="btn btn-danger">Supprimer</button></a>
					</div>
				  </td>
				</tr>
			<?php }?>
